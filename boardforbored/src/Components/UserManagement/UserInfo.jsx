...
export default function UserInfo(props) {
    ...
    return (
        <>
            <Header />
            <div>
                <section className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 px-40 py-2">
                            ...
                            <div className="mt-10 pr-0.5 max-md:max-w-full max-md:mt-10">
                                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                                    ...
                                    <div className="flex flex-col items-stretch w-5/12 ml-5 max-md:w-full max-md:ml-0">
                                        <div className="flex text-gray-600 text-2xl leading-5 whitespace-nowrap justify-center items-center bg-gray-300 
