                ...
                <section className="self-center w-full max-w-[1054px] px-5 max-md:max-w-full">
                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        <div className="flex flex-col items-stretch w-[49%] max-md:w-full max-md:ml-0">
                            <h1 className="text-gray-600 text-7xl mt-3 max-md:max-w-full max-md:text-5xl max-md:mt-10">
                        ...
                        <div className="flex flex-col items-stretch w-[41%] ml-5 max-md:w-full max-md:ml-0 opacity-25">
                            <img
                                loading="lazy"
                                ...
                                className="aspect-[1.83] object-contain object-center w-full overflow-hidden mt-5 max-md:max-w-full max-md:mt-10"
                            />
                        </div>
                    </div>
                </section>
