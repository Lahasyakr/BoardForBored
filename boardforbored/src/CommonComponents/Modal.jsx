    ...
    return (
        ...
        items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div className="relative bg-gray-300 rounded-lg shadow dark:bg-gray-300">

                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-300">
                        <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-600">
                            {props.title}
                        </h3>
                        <button type="button" onClick={() => props.onCancel()} className="text-gray-900 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white">
                    ...
                    <div className={`p-4 md:p-5 border-t border-gray-600 rounded-b dark:border-gray-600 right-0 ${props?.centerButtons ? 'text-center' : 'text-right'}`}>
                        <button type="button" className="text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none 
                        focus:bg-yellow-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-yellow-600 dark:hover:bg-yellow-600 
                        dark:focus:ring-blue-800" onClick={() => props.onSubmit()}>{props.okText}</button>
                        <button type="button" className="ms-3 text-gray-500 bg-gray-700 hover:bg-gray-100 focus:ring-4 focus:outline-none 
